...
- While "Data science" is oft used, its definitions vary
    - [Click here](https://remiller1450.github.io/s395s20/ds_proj_pipe.pdf) to see some examples of this
...
> After revising the linear regression model in the previous example, a final model is chosen and is applied a "test set" of 100 new records that occured after the original dataset was finalized. The model predicts A1c within 10% of the actual value for 86% of these new records.
